...
library(dplyr)
OOL.sub <- OOL %>% 
   rename(InterestPol = W1_A1, ThoughtsElections = W1_A2, WatchNews = W1_A11, PoliticalAffil = W1_C1, Welfare = W1_N1A) 
summary(OOL.sub)
...
OOL.sub <- OOL.sub %>%
   select(InterestPol, ThoughtsElections, WatchNews, PoliticalAffil, Welfare)
```
